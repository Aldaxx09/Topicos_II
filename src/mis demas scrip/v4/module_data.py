...
class DataProcessor:
    ...
    def get_processed_data(self, clean_method='mean', scaler_method='standard', feature_method='rfecv'):
        ...
        if clean_method in ['mean', 'most_frequent']:
            ...
            # Usamos asignación directa [:] para mantener nombres de columnas
        ...
        if scaler_method != 'none':
            ...
            # Como ya convertimos a float arriba, esto ya no dará warnings
        ...
        if feature_method == 'rfecv':
            ...
            if os.path.exists(RFECV_MODEL_PATH):
                ...
                est = LogisticRegression(random_state=self.seed, max_iter=1000, solver='liblinear')

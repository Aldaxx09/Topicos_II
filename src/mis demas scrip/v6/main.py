...
SCALING_STRATEGY = 'minmax' # minmax o standard
FEATURE_SELECTION_STRATEGY = 'rfecv' # none o rfecv, pca
MODEL_NAME = 'LogisticRegression' # LogisticRegression, RandomForest, XGBoost, etc
# =================================================

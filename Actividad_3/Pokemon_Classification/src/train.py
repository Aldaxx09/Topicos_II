...
def main():
    # Hiperparámetros (Ajustados para velocidad)
    ...
    data_transform = transforms.Compose([
        ...
        transforms.ToTensor(),
        # Normalización estándar para convergencia rápida
    ...
    # Guardar
    utils.save_model(model=model, target_dir="models", model_name="tinyvgg_v1.pth")
